...
import { Loader2, ChevronDown, ChevronUp, Edit } from 'lucide-react';
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-start">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500 mt-1">Requested {formatRelativeTime(request.createdAt)}</p>
            </div>
          </div>
          <div className="flex items-center">
            {request.status === 'pending' && (
      ...
      <Dialog open={showEditModal} onOpenChange={setShowEditModal}>
        <DialogContent>
          ...
          {editItem && (
            <div className="py-4">
              <div className="mb-4">
                <p className="text-sm font-medium">Resource: <span className="font-normal">{editItem.table?.name}</span></p>
              </div>

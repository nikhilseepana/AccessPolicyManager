...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/api/schemas/:id', isAuthenticated, async (req, res) => {
    try {
      ...
      console.error(`Failed to fetch schema ID ${req.params.id}:`, error);
  ...
  app.get('/api/access-requests/:id', isAuthenticated, async (req, res) => {
    try {
      ...
      console.error(`Failed to fetch access request ID ${req.params.id}:`, error);
  ...
  app.patch('/api/access-requests/:id', isAdmin, async (req, res) => {
    try {
      ...
      const request = await storage.updateAccessRequestStatus(parseInt(req.params.id), status);
      ...
      console.error(`Failed to update access request ID ${req.params.id}:`, error);
  ...
  app.post('/api/access-policies/copy', isAdmin, async (req, res) => {
    try {
      ...
      await storage.copyUserAccessPolicies(
      ...
      console.error('Failed to copy access policies:', error);
  ...
  app.patch('/api/notifications/:id/read', isAuthenticated, async (req, res) => {
    try {
      ...
      console.error(`Failed to mark notification ID ${req.params.id} as read:`, error);
